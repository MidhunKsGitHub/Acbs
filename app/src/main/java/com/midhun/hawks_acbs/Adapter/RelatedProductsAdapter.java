...
public class RelatedProductsAdapter extends RecyclerView.Adapter<RelatedProductsAdapter.HomeProductsViewHolder> {

    Context mCtx;
    List<Products> productsList;

    public RelatedProductsAdapter(Context mCtx, List<Products> productsList) {
        this.mCtx = mCtx;
    ...
    public HomeProductsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mCtx).inflate(R.layout.relatedproduct_item, parent, false);
