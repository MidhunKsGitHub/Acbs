...
import com.midhun.hawks_acbs.View_Photo_Activity;
...
public class ViewProductsAdapter extends RecyclerView.Adapter<ViewProductsAdapter.ViewProductsViewHolder> {
    ...
    public ViewProductsAdapter(Context mtx, List<ProductById> productImageList) {
        this.mtx = mtx;
    ...
    @NonNull
    @Override
    public ViewProductsAdapter.ViewProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mtx).inflate(R.layout.view_product_item, parent, false);
