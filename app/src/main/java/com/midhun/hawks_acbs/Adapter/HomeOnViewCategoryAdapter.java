...
public class HomeOnViewCategoryAdapter extends RecyclerView.Adapter<HomeOnViewCategoryAdapter.HomeProductsViewHolder> {

    Context mCtx;
    List<Products> productsList;

    public HomeOnViewCategoryAdapter(Context mCtx, List<Products> productsList) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(HomeProductsViewHolder holder, int position) {
        ...
        holder.brand_catview.setText(products.getBrand());
