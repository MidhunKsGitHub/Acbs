...
public class ImagesEdit {
    ...
    public ImagesEdit(String name, String imageUrl, String code, String customer, String category, String brand, String amount, String discount, String hsn, String latitude, String longitude, String tax, String description, List<String> detail_images) {
        this.name = name;
        this.code = code;
        this.customer = customer;
        this.category = category;
